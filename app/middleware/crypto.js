// gulp-header to include header

// echo -n "secret_key" | openssl dgst -sha256 -hmac "secret_value"
// echo -n "secret_hmac_key" | openssl dgst -sha256 -hmac "secret_hmac_value"
...
const blob = encrypt('asdas');
//console.log(blob);
const unblob = decrypt(blob);
//console.log(unblob);
